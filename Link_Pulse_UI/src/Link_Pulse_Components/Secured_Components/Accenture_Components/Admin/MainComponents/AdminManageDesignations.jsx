...
const AdminManageDesignations = () => {
    ...
    const checkIfDepartmentsAreAvailable = async (pageNumber) => {
        ...
        try{
            ...
            const response = await axios.get(`http://localhost:7777/api/v1/accenture-admin/fetchAllDesignations/${page}/${pageSize}`, {
                headers: {
    ...
    // Function to show add department option
    ...
    const addDepartmentFunction = async () => {
        ...
        try{
            ...
            const response = await axios.post('http://localhost:7777/api/v1/accenture-admin/addDesignation', formData, {
                headers: {
                    'Authorization': `Bearer ${access_token}`
                }
            })
    ...
    const DepartmentDeleteFunction = async (id) => {
        ...
        try{
            ...
            const response = await axios.delete(`http://localhost:7777/api/v1/accenture-admin/deleteDesignationById/${designationId}`, {
                headers: {
                    'Authorization': `Bearer ${access_token}`
                }
            })
    ...
    const editButtonManageDepartment = async (id) => {
        ...
        try{
            ...
            const response = await axios.get(`http://localhost:7777/api/v1/accenture-admin/getDesignationById/${designationId}`, {
                headers: {
                    'Authorization': `Bearer ${access_token}`
                }
            })
    ...
    return (
        ...
        <>
            ...
            <Helmet>
                <title> Admin Manage Designations | Accenture </title>
                        ...
                        <div className="bg-white border-2 border-gray-200 px-10 rounded-xl py-10">
                            ...
                            >
                                ...
                                <div className="">
                                    ...
                                    <label className='text-gray-600'> Designation name <span className='text-red-500'>*</span> </label><br />
                ...
                <div className="flex items-center z-0">
                    ...
                    <div className="bg-white px-5 py-5 mr-10 flex w-full mb-20">
                        ...
                        <div className="space-y-3 block w-full">
                            ...
                            <span className='font-semibold'>Designations</span> | Showing all designations
                                ...
                                {showAddProject && (
                                    ...
                                    <div className="flex items-center space-x-5">
                                        ...
                                        <div className="flex items-center space-x-5 transition-all">
                                            ...
                                            <label  className='text-sm text-gray-600  font-semibold'>Designation Name</label> <br />
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    {designationData && designationData.length > 0 && (
                                        ...
                                        designationData.map((department, index) => (
...
export default AdminManageDesignations