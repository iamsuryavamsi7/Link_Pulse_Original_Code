...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponseModel> authentication(
        ...
        AuthenticationResponseModel response = authService.authenticate(request, subDomain);
